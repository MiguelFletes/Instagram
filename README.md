...
1. How to display the picture using the queries
2. How to display the author using the queries

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<a href="https://imgur.com/uSqgaNl"><img src="https://i.imgur.com/uSqgaNl.gif" title="source: imgur.com" /></a>
...
Spent more than half the time trying to display the picture with the caption.
